...
const Quizlist =()=>{
   ...
   //menu select filter
   let category:any = localStorage.getItem("MENU_CATEORY_TYPE")
   let unique_list:any = quizlist.length>0 && Array.from(new Set(quizlist.map((q:any) => q.CategoryName)));
   //filter
                 ...
                 <ul className="quiz-option main">
                   {
                      ...
                      unique_list.map((item:any,index:any)=>{
                         return( 
                 ...
                 <div className="search-text-box-quiz">
                 ...
                 
                    {
                        ...
                        <ul className="notification">
                          { sort_Data.map((item:any,index:any)=>{
