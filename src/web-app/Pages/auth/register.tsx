...
import { handleRegistration } from "../../Service/utility";
                    ...
                    <form onSubmit={(e)=>handleRegistration(e,emailId,password,firstname,lastname,termsAndConditions,navigator,setError,toastdispatch)}>
                        <div className="flex-row">
                            <section>
                                ...
                                <div className="flex-row  col-gap-2rem textField-container">  
                                    <input type="email" name="email" value={emailId} placeholder="johndoe@gmail.com"  className="text-input" style={{color:darkTheme?"white":"black"}} onChange={(e)=>validateemail(e)} required/>
                                    <label className="text-placeholder"> Email Id </label>                                                
                                </div>
                            </section>
                            <section>
                                <div className="flex-row  col-gap-2rem textField-container">  
                                    <input type= {hideshowpassword?"text":"password"} name="password" value={password} className="text-input"  style={{color:darkTheme?"white":"black"}}  onChange={(e)=>{setPassword(e.target.value)}} required/>
